    ...
    <div class="max-w-4xl mx-auto px-4 text-center relative z-10">
        ...
        <div class="mb-8">
            <div class="flex items-center justify-center space-x-3 mb-2">
                <img src="<?php echo BASE_URL; ?>assets/images/logo.png" alt="LDX Software" class="h-12 w-auto">
        ...
        <div class="mb-6">
            <a href="<?php echo url('libro-reclamaciones'); ?>" 
               class="inline-flex items-center gap-2 text-gray-400 hover:text-yellow-400 transition-colors duration-300 border border-gray-700 hover:border-yellow-500 px-4 py-2 rounded-lg">
